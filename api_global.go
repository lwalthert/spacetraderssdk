...
*/
func (a *GlobalAPIService) GetStatus(ctx context.Context) ApiGetStatusRequest {
	return ApiGetStatusRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GlobalAPIService) GetStatusExecute(r ApiGetStatusRequest) (*GetStatus200Response, *http.Response, error) {
	var (
...
*/
func (a *GlobalAPIService) Register(ctx context.Context) ApiRegisterRequest {
	return ApiRegisterRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GlobalAPIService) RegisterExecute(r ApiRegisterRequest) (*Register201Response, *http.Response, error) {
	var (
