...
func Test_spacetraderssdk_FleetAPIService(t *testing.T) {
	...
	t.Run("Test FleetAPIService GetShipModules", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var shipSymbol string

		resp, httpRes, err := apiClient.FleetAPI.GetShipModules(context.Background(), shipSymbol).Execute()
	...
	t.Run("Test FleetAPIService InstallShipModule", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var shipSymbol string

		resp, httpRes, err := apiClient.FleetAPI.InstallShipModule(context.Background(), shipSymbol).Execute()
	...
	t.Run("Test FleetAPIService RemoveShipModule", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var shipSymbol string

		resp, httpRes, err := apiClient.FleetAPI.RemoveShipModule(context.Background(), shipSymbol).Execute()
