...
func (r ApiExtractResourcesWithSurveyRequest) Execute() (*ExtractResourcesWithSurvey201Response, *http.Response, error) {
...
func (a *FleetAPIService) ExtractResourcesWithSurveyExecute(r ApiExtractResourcesWithSurveyRequest) (*ExtractResourcesWithSurvey201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiGetShipModulesRequest struct {
	ctx context.Context
	ApiService *FleetAPIService
	shipSymbol string
}

func (r ApiGetShipModulesRequest) Execute() (*GetShipModules200Response, *http.Response, error) {
...
Get the modules installed on a ship.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param shipSymbol The symbol of the ship
 @return ApiGetShipModulesRequest
*/
func (a *FleetAPIService) GetShipModules(ctx context.Context, shipSymbol string) ApiGetShipModulesRequest {
	return ApiGetShipModulesRequest{
		ApiService: a,
		ctx: ctx,
		shipSymbol: shipSymbol,
...
func (a *FleetAPIService) GetShipModulesExecute(r ApiGetShipModulesRequest) (*GetShipModules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiInstallShipModuleRequest struct {
	ctx context.Context
	ApiService *FleetAPIService
	shipSymbol string
...
func (r ApiInstallShipModuleRequest) InstallShipModuleRequest(installShipModuleRequest InstallShipModuleRequest) ApiInstallShipModuleRequest {
	r.installShipModuleRequest = &installShipModuleRequest
	return r
}

func (r ApiInstallShipModuleRequest) Execute() (*InstallShipModule201Response, *http.Response, error) {
...
Install a module on a ship. The module must be in your cargo.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param shipSymbol The symbol of the ship
 @return ApiInstallShipModuleRequest
*/
func (a *FleetAPIService) InstallShipModule(ctx context.Context, shipSymbol string) ApiInstallShipModuleRequest {
	return ApiInstallShipModuleRequest{
		ApiService: a,
		ctx: ctx,
		shipSymbol: shipSymbol,
...
func (a *FleetAPIService) InstallShipModuleExecute(r ApiInstallShipModuleRequest) (*InstallShipModule201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiPatchShipNavRequest) Execute() (*PatchShipNav200Response, *http.Response, error) {
...
func (a *FleetAPIService) PatchShipNavExecute(r ApiPatchShipNavRequest) (*PatchShipNav200Response, *http.Response, error) {
	var (
...
type ApiRemoveShipModuleRequest struct {
	ctx context.Context
	ApiService *FleetAPIService
	shipSymbol string
...
func (r ApiRemoveShipModuleRequest) RemoveShipModuleRequest(removeShipModuleRequest RemoveShipModuleRequest) ApiRemoveShipModuleRequest {
	r.removeShipModuleRequest = &removeShipModuleRequest
	return r
}

func (r ApiRemoveShipModuleRequest) Execute() (*RemoveModule201Response, *http.Response, error) {
...
Remove a module from a ship. The module will be placed in cargo.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param shipSymbol The symbol of the ship
 @return ApiRemoveShipModuleRequest
*/
func (a *FleetAPIService) RemoveShipModule(ctx context.Context, shipSymbol string) ApiRemoveShipModuleRequest {
	return ApiRemoveShipModuleRequest{
		ApiService: a,
		ctx: ctx,
		shipSymbol: shipSymbol,
...
func (a *FleetAPIService) RemoveShipModuleExecute(r ApiRemoveShipModuleRequest) (*RemoveModule201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
