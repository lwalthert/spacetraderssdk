...
func (dst *GetSystemWaypointsTraitsParameter) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonWaypointTraitSymbol) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.WaypointTraitSymbol); err != nil {
				dst.WaypointTraitSymbol = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonArrayOfWaypointTraitSymbol) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ArrayOfWaypointTraitSymbol); err != nil {
				dst.ArrayOfWaypointTraitSymbol = nil
			} else {
				match++
			}
	...
	if match > 1 { // more than 1 match
		...
		if err != nil {
			return fmt.Errorf("data failed to match schemas in oneOf(GetSystemWaypointsTraitsParameter): %v", err)
		}
