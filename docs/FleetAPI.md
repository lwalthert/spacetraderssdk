...
> ExtractResourcesWithSurvey201Response ExtractResourcesWithSurvey(ctx, shipSymbol).Survey(survey).Execute()
...
func main() {
	...
	// response from `ExtractResourcesWithSurvey`: ExtractResourcesWithSurvey201Response
